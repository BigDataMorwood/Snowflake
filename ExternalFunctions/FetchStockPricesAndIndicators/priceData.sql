...
create or replace external function EXT_UDF_fetch_asset_price_data(symbol string, fromDate int, toDate int)
    ...
    as 'https://mxv6dviy6g.execute-api.ap-southeast-2.amazonaws.com/prod/fetchassetpricedata';
...
select EXT_UDF_fetch_asset_price_data('AAPL', 1590969600, 1595808000) as apiData;


// Now lets make it dynamically fetch the last 30 days
set daysHistory = 30;
select $daysHistory;
